      ...
      <div className="mt-10 grid w-full max-w-6xl grid-cols-1 justify-center gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-1">
        {services.map((service) => (
          <div
            key={service.title}
            className={cn(
              'relative flex flex-col gap-2 overflow-hidden rounded-xl border border-neutral-300 p-6 text-neutral-800',
              service.title === 'Web Development' && 'bg-gradient-to-tr from-violet-400 to-fuchsia-400'
            )}
          >
            <div className={cn(
              'flex items-center gap-2 bg-gradient-to-r from-violet-500 to-fuchsia-500 bg-clip-text text-lg font-semibold text-transparent',
            ...
            <p className={cn(
              'text-xl font-semibold text-inherit',
            ...
            <svg viewBox="0 0 82 82" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className='absolute -bottom-16 -right-16 h-64 w-64 opacity-5'>
