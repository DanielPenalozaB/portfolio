        ...
        {displayedProjects.map((project) => (
          <div
            ...
            className={cn(
              ...
              'group h-64 lg:h-full row-span-1 overflow-hidden rounded-lg outline outline-transparent hover:outline-4 touch-manipulation active:outline-violet-500 hover:outline-violet-500 bg-violet-200 backdrop-blur-sm transition-all duration-300'
            )}
          >
            <img
              ...
              width={800}
              height={600}
              className="tou h-full w-full object-cover transition-transform duration-500 group-hover:scale-105 group-active:scale-105"
            />
            <div className="absolute inset-0 flex touch-manipulation flex-col justify-end bg-gradient-to-t from-violet-800 via-transparent to-transparent p-6 group-hover:gap-4 group-hover:via-violet-800/50 group-hover:backdrop-blur-md group-active:gap-4 group-active:via-violet-800/50 group-active:backdrop-blur-md">
              <Link
              ...
              >
                ...
                <p className="line-clamp-2 max-h-0 touch-manipulation text-sm font-light text-neutral-300 no-underline opacity-0 transition-all duration-300 ease-in-out group-hover:max-h-10 group-hover/title:underline group-hover:opacity-100 group-active:max-h-10 group-active:opacity-100">
                  {project.description}
                </p>
              </Link>
              <div className="flex max-h-0 touch-manipulation flex-wrap gap-2 opacity-0 transition-all duration-300 group-hover:max-h-10 group-hover:opacity-100 group-active:max-h-10 group-active:opacity-100">
              ...
              <div className="flex max-h-0 touch-manipulation gap-2 opacity-0 transition-all duration-300 group-hover:max-h-10 group-hover:opacity-100 group-active:max-h-10 group-active:opacity-100">
                {project.github && (
                  <Button
                    size='sm'
                    href={project.github}
                    className="bg-violet-600/0! hover:text-violet-100! active:text-violet-100! border-transparent! hover:bg-violet-700! h-8 touch-manipulation hover:backdrop-blur-sm"
                  >
                ...
                {project.demo && (
                  <Button
                    size='sm'
                    href={project.demo}
                    className="bg-fuchsia-600/0! hover:text-fuchsia-100! active:text-fuchsia-100! border-transparent! hover:bg-fuchsia-800! active:bg-fuchsia-800! h-8 touch-manipulation hover:backdrop-blur-sm active:backdrop-blur-sm"
                  >
      ...
      {isMobile && projects.length > 3 && (
        <div className="mt-8 text-center">
          <Button
            href="/projects"
            variant="outline"
            className="mx-auto touch-manipulation border-violet-500 text-violet-500 hover:bg-violet-500 hover:text-white active:bg-violet-500 active:text-white"
          >
            View All Projects
          </Button>
        </div>
